...
constexpr wchar_t kHostClassName[] = L"LynxFastImageElementNativeUIHost";
...
class LynxFastImageElementNativeUIView : public LynxFastImageElementView {
 public:
  explicit LynxFastImageElementNativeUIView(void* opaque)
      : LynxFastImageElementView(opaque) {}

  ~LynxFastImageElementNativeUIView() override {
    if (label_ != nullptr) {
...
lynx_native_view_t* CreateLynxFastImageElementNativeUINativeView(void* opaque) {
  auto* view = new LynxFastImageElementNativeUIView(opaque);
